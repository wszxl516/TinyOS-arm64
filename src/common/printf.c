...
static void
putchw (void *putp, putcf putf, struct param *p)
{
  char ch;
  int n = p->width;
  char *bf = p->bf;
...
void
k_format (void *putp, putcf putf, const char *fmt, va_list va)
{
  struct param p;
...
static void
_vsnprintf_putcf (void *p, char c)
{
...
int
k_vsnprintf (char *str, usize size, const char *format, va_list ap)
{
...
int
k_snprintf (char *str, usize size, const char *format, ...)
{
  va_list ap;
  int retval;
...
int
k_vsprintf (char *str, const char *format, va_list ap)
{
...
int
k_sprintf (char *str, const char *format, ...)
{
  va_list ap;
  int retval;
